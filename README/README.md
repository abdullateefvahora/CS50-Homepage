This is a website that allows users to buy, sell and quote all public stocks. These actions affect a users and indexes database and tracks current prices of stocks
to observe how a user's portfolio is performing. 
It contains a login and register page to ensure portfolio data is only shown to the correct user that would be logged in.
This program uses Python and Flask.
A video has been uploaded in this repository to walkthrough the front end of the website.
Below is the specification given to me to complete this website.
